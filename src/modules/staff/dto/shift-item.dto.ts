...
export class ShiftItemDto {
  @ApiProperty({ type: String, example: '2026-10-01', description: 'Date in YYYY-MM-DD format' })
  date: string;

  @ApiProperty({ type: String, example: '09:00', description: 'Start time HH:mm in business timezone' })
  startTime: string;

  @ApiProperty({ type: String, example: '18:00', description: 'End time HH:mm in business timezone' })
  endTime: string;
